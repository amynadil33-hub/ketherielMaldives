...
const TRANSLATIONS = {
  ...
  "sec.ai.kicker": { en: "Raalhu AI Concierge", dv: "ރާޅު އޭއައި ކޮންސިއަރޖް" },
  ...
  "pay.dhiraagu.note": { en: "Pay to merchant Raalhu", dv: "Raalhu މަރޗަންޓަށް ޕޭ" },
  ...
  "ai.panel.title": { en: "Raalhu AI", dv: "ރާޅު އޭއައި" },
  ...
  "ai.panel.greeting": { en: "Hey! I'm Raalhu, your shopping concierge for Maldives. Ask me anything — I can find products, suggest gifts, explain delivery, or draft a custom sourcing quote.", dv: "ހެލޯ! އަޅުގަނޑު ރާޅު, ތިޔަ ޝޮޕިންގ ކޮންސިއަރޖް. ހުރިހާ ކަމެއް އަހާ — ޕްރޮޑަކްޓްސް ހޯދާ, ހަދިޔާ ހުށަހަޅާ, ޑެލިވަރީ ބަޔާންކޮށް, ކޯޓޭޝަން ތައްޔާރުކޮށްދޭނަން." },
  "ai.fab": { en: "Ask Raalhu AI", dv: "ރާޅު އޭއައި އަށް އަހާ" },
  ...
  "foot.bottom": { en: "Raalhu Concierge · A premium Maldives retail experience", dv: "ރާޅު ކޮންސިއަރޖް · ޕްރީމިއަމް ދިވެހި ރީޓެއިލް ތަޖުރިބާ" },
