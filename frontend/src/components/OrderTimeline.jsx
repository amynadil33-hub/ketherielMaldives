        ...
        return (
          <li key={stage.key} className="relative flex gap-4">
            ...
            <div className="pb-2 flex-1">
              <div className={`font-semibold text-sm ${done ? "text-slate-900" : "text-slate-400"}`}>{stage.label}</div>
              {isCurrent && <div className="text-xs text-amber-700">In progress · admin will confirm via WhatsApp</div>}
            </div>
          </li>
        );
      })}
