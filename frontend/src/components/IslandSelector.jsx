    ...
    <Dialog open={open} onOpenChange={(o) => { if (!o) onClose(); }}>
      <DialogContent className="max-w-md p-0 overflow-hidden rounded-2xl">
        <DialogHeader className="px-6 pt-6">
          <DialogTitle className="font-display text-2xl">Delivering to your island</DialogTitle>
          <p className="text-sm text-slate-500">We adjust delivery fee & time based on your atoll.</p>
        </DialogHeader>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-slate-500">{i.atoll} atoll</div>
                </div>
                <div className="text-right text-xs">
                  <div className="font-semibold text-slate-900">{formatMVR(i.fee)}</div>
                  <div className="text-slate-500">+{i.min}–{i.max} days</div>
                </div>
              </button>
            );
          })}
